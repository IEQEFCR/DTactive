"""
This is a serial controller for STM32 board, which is equipped with 3 Stepper Motors and 3 Angle Sensors.
...
class STM32Ctrl:
    ...
    def process_byte(self, byte):
        ...
        # print("flag",self.end_flag," byte", byte)
        # 结束标识符 0x41 0x49
        if self.end_flag == 0:
            if byte == 0x41:
                self.end_flag = 1
